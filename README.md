...
| [13-六类用户画像.md](./13-六类用户画像.md) | 6 类用户详细画像 + 优先级分层 | **「用户是谁」** |
| [14-风险与应对矩阵.md](./14-风险与应对矩阵.md) | 市场/技术/竞争/合规/供应链风险 | **「怕什么」** |
| [15-上市策略GTM.md](./15-上市策略GTM.md) | 分阶段上市 + 渠道 + 定价 + 传播 | **「怎么卖」** |
| [16-产品功能规格清单.md](./16-产品功能规格清单.md) | 功能清单 + 优先级 + 验收标准 | **「做什么功能」** |
